...
*Activating VK_LAYER_KHRONOS_synchronization2 from Vulkan Configurator*
...
*A Write-after-write hazard on render pass 0x1a8aa6cf148*
...
*The [VkSubpassDependency](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubpassDependency.html) structure*
...
![Implicit subpass dependencies](https://i.imgur.com/yXqvt0f.png)*The implicit subpass dependencies (Vulkan specification)*
...
*Pipeline stage and access compatibility chart, green means compatible, red means not compatible*
### Example
